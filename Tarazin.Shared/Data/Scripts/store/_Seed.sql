-- =============================================
-- Tarazin.Shared/Data/Scripts/store/_Seed.sql
-- Schema: store
...
BEGIN
    ...
    VALUES
        (N'CST-001', N'سارا رضایی', N'09121234567', N'sara@example.ir', 1, SYSUTCDATETIME()),
        (N'CST-002', N'حسین نوری',  N'09351112233', N'hossein@example.ir', 1, SYSUTCDATETIME());
END
...
BEGIN
    ...
    VALUES
        (N'P-GOLD24', N'سکه طلا (امامی) — ۱ عدد', N'SIKKEH', 62000000, 1, SYSUTCDATETIME()),
        (N'P-GOLD18', N'طلای ۱۸ عیار — ۱ گرم',    N'GOLD-18', 28000000, 1, SYSUTCDATETIME()),
        (N'P-CHAIN',  N'زنجیر طلا طرح دار',        N'CHAIN-01', 45000000, 1, SYSUTCDATETIME());
END
...
BEGIN
    ...
    VALUES (N'ORD-00001', 1, N'سارا رضایی', CAST(SYSDATETIME() AS DATE), 1, 62000000, N'IRR', N'Placed', SYSUTCDATETIME());
