...
SELECT t.FxTransactionId, t.TransactionNumber, t.TransactionDate,
       ...
       (SELECT COUNT(*) FROM [currency].[FxTransactionLegs] l WHERE l.FxTransactionId = t.FxTransactionId) AS LegCount,
       t.CreatedBy, t.CreatedAt
FROM [currency].[FxTransactions] t
LEFT JOIN [accounting].[Documents] d ON d.DocumentId = t.DocumentId
