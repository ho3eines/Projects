...
-- Schema: inventory
-- Query. کارتکس کالا با ماندهٔ جاری (تعداد و ارزش) — به تفکیک انبار/انبارک اختیاری.
-- =============================================
...
SELECT
    ...
    CASE WHEN m.MovementType = N'Issue' THEN (m.Qty * m.CostPrice) ELSE (m.Qty * m.UnitPrice) END AS OutValue,
...
-- ماندهٔ ابتدای دوره (حرکات قبل از @FromDate برای همین کالا/انبار)
