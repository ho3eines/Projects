...
public static class TarazinTheme
{
    ...
    public static MudTheme Create() => new()
    {
        ...
        Typography = new Typography
        {
            ...
            H4 = new H4Typography { FontFamily = Fonts, FontWeight = "700", FontSize = "1.55rem", LetterSpacing = "-0.02em", LineHeight = "1.35" },
            H5 = new H5Typography { FontFamily = Fonts, FontWeight = "700", FontSize = "1.25rem", LetterSpacing = "-0.015em" },
            H6 = new H6Typography { FontFamily = Fonts, FontWeight = "600", FontSize = "1.05rem" },
            ...
            Body1 = new Body1Typography { FontFamily = Fonts, LineHeight = "1.8" },
            Body2 = new Body2Typography { FontFamily = Fonts, LineHeight = "1.75", FontSize = "0.875rem" },
            Button = new ButtonTypography { FontFamily = Fonts, FontWeight = "600", TextTransform = "none", LetterSpacing = "0" },
            Caption = new CaptionTypography { FontFamily = Fonts, FontWeight = "500" },
