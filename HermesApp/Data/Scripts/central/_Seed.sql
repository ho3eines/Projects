-- =============================================
-- HermesApp/Data/Scripts/central/_Seed.sql
-- Schema: central
...
BEGIN
    ...
    VALUES
        (N'افتتاح پلتفرم هرمس', N'هفت محصول روی یک پلتفرم یکپارچه در دسترس قرار گرفت.', N'پلتفرم یکپارچهٔ هرمس شامل حسابداری، انبار، خزانه‌داری، حقوق، طلافروشی و فروشگاه اینترنتی راه‌اندازی شد.', CAST('2026-08-12' AS DATE), 1, N'seed'),
...
BEGIN
    ...
    VALUES
        (N'معماری پلتفرم هرمس', N'hermes-architecture', N'معماری تک‌وب‌سرویسی با اسکیمهٔ جدا برای هر محصول و بک‌بون رویدادها با Outbox.', N'تیم معماری', N'معماری, Outbox, امنیت', CAST('2026-08-12' AS DATE), 1, N'seed'),
